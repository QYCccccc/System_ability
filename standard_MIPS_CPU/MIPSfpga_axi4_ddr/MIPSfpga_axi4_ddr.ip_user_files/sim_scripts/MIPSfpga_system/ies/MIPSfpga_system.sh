...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.MIPSfpga_system \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../MIPSfpga_axi4_ddr.srcs/sources_1/ipshared/bd6d/rtl_up" \
       +incdir+"$ref_dir/../../../../MIPSfpga_axi4_ddr.srcs/sources_1/bd/MIPSfpga_system/ipshared/b65a" \
       +incdir+"$ref_dir/../../../../MIPSfpga_axi4_ddr.srcs/sources_1/bd/MIPSfpga_system/ipshared/ec67/hdl" \
       +incdir+"../../../../MIPSfpga_axi4_ddr.srcs/sources_1/ipshared/bd6d/rtl_up" \
       +incdir+"../../../../MIPSfpga_axi4_ddr.srcs/sources_1/bd/MIPSfpga_system/ipshared/b65a" \
       +incdir+"../../../../MIPSfpga_axi4_ddr.srcs/sources_1/bd/MIPSfpga_system/ipshared/ec67/hdl"
}
